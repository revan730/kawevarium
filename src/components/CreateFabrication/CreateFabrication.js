...
export default class CreateFabrication extends Component {
  ...
  loadTypes = async () => {
    try {
      const response = await axios.get(backend.fabTypesUrl);
  ...
  register = async () => {
    try {
      const response = await axios.post(backend.fabricationsUrl, {
